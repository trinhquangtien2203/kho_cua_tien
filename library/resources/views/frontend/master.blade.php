...
<head>
	...
	<link rel="stylesheet" href="bosung.css">
...
<body>    
					...
					<form class="navbar-form" role="search" action="{{asset('search/')}}" method="get">
						<div class="input-group">
							<div class="input-group-btn">
								<input id="search-text" class="form-control" style="border-radius:0;" type="text" name="result" placeholder="Nhập từ khóa ...">
							</div>
							<div class="input-group-btn" style="width: 100px;">
								<input class="form-control" style="border-radius:0;" type="submit" value="Tìm Kiếm">
							</div>
						</div>
	...
	<div class="header-menu container-menu">
		<div class="container">
			<div class="row">
				<div id="menu1" >
						<div class="item"><a href="{{asset('laptop')}}"><i class="fas fa-laptop"></i> LAPTOP</a></div>
						<div class="item"><a href="#"><i class="fas fa-tablet-alt"></i> TABLET</a></div>
						<div class="item"><a href="#"><i class="far fa-credit-card"></i> SIM THẺ</a></div>
						<div class="item"><a href="{{asset('news')}}"><i class="far fa-newspaper"></i> TIN TỨC</a></div>	
				</div>
			</div>			
		</div>
	</div>
