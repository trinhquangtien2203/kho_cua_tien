						...
						<div id="list-cart">
							...
							<form>
								<table class="table table-bordered .table-responsive text-center">
									...
									<tr>
										<td><img class="img-responsive" src="{{asset('library/storage/app/avarta/'.$item->attributes->img)}}"></td>
										<td>{{$item->name}}</td>
										<td>
										...
										<td><a href="{{asset('cart/del/'.$item->id)}}">Xóa</a></td>
									</tr>
									@endforeach
								</table>
								<div class="row" id="total-price">
									...
									<div class="col-md-6 col-sm-12 col-xs-12">
										...
										<a href="{{asset('cart/del/all')}}" class="my-btn btn">Xóa giỏ hàng</a>
									</div>
								</div>
							</form>
							<div id="xac-nhan">
